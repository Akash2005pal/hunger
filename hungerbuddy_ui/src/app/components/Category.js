...
{  const theme = useTheme();
  ...
  const serverUrl=process.env.serverUrl
   var data=[{categoryid:1,categoryname:'South Indian',icon:'southindian.png'},
    {categoryid:2,categoryname:'Poha',icon:'poha1.png'},
    {categoryid:3,categoryname:'South Indian',icon:'southindian.png'},
    {categoryid:4,categoryname:'Breakfast',icon:'kurkure.png'},
    {categoryid:5,categoryname:'South Indian',icon:'southindian.png'},
